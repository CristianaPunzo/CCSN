...
video_filename = fullfile('immagini', 'nominale_wp.mp4');
v = VideoWriter(video_filename, 'MPEG-4');
v.FrameRate = 10;  % Puoi modificare il frame rate se necessario
open(v);
...
for i = 1:T-1
    ...
    % Posiziona le etichette leggermente all'esterno del cerchio
    x_text = 1.1*x;
    y_text = 1.1*y;
    for j = 1:n
